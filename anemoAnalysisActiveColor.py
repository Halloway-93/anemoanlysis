...
def perm_test(x, y, n_perms=1000, stat=np.nanmean):
    ...
    return pv
# %%
perm_test(result_df[result_df['color']=='Green']['DiffGreen'].values,result_df[result_df['color']=='Green']['DiffRed'].values)

# result_df[result_df['color']=='Green']['DiffGreen'].values
# %% 
perm_test(result_df[result_df['color']=='Red']['DiffGreen'].values,result_df[result_df['color']=='Red']['DiffRed'].values)
# %%
