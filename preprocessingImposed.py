...
for idxSub, sub in enumerate(subjects):
    ...
    for cond in conditions:
        try:
            ...
            paramsSub.to_hdf(h5_file, "imposedColorData/")
            paramsRaw.to_hdf(h5_rawfile, "imposedColorData/")
            qualityCtrl.to_hdf(h5_qcfile, "imposedColorData/")

            # test if it can read the file
            abc = pd.read_hdf(h5_file, "imposedColorData/")
            abc.head()
