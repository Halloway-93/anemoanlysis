...
def plotFig(trial_idx, tg_dir_h, time_x, vel_x, equ_x, start_a_x, lat_x, trialType='', ax=None, show=False) -> None:
    ...
    box_x = (time_all > start_a_x) & (time_all < lat_x)
    ...
    plt.text(start_a_x, 20, 'start anticip.', ha='right', va='top', rotation=90)
